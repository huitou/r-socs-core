...
const connect = (Model, name) => TargetComponent => {
  ...
  class HConnect extends React__default.Component {
    ...
    render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(HInjector, _extends({
        hprops: hprops
      }, rest, {
        ref: this.root.ref,
        getCollector: this.getCollector
      })), React__default.createElement(Model, _extends({}, hprops, {
        hset: hset
      })));
    }
...
_defineProperty(MapModelComponent, "propTypes", {
  hprops: PropTypes.object,
  map: PropTypes.object // TODO: be more specific.
