...
const getHandleNode = inputNode => {
  ...
  inputNode.children && Object.entries(inputNode.children).reduce((acc, cur) => {
...
const connect = (ModelComponent, name) => TargetComponent => {
  class HInjector extends React.Component {
    render() {
      ...
      return collector ? React.createElement(TargetComponent, _extends({}, this.props, {
        getCollector: undefined
      }, collector.valueAndHandleTree())) : null;
    }
  ...
  const HConnect = props => {
    ...
    return React.createElement(React.Fragment, null, React.createElement(HInjector, _extends({}, props, {
      ref: root.ref,
      getCollector: getCollector,
      hprops: undefined
    })), React.createElement(ModelComponent, _extends({}, props.hprops, {
      hset: hset
    })));
  };
...
export { Collector, withCollector, connect };
